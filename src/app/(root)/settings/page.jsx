  ...
  return (
    <section className="py-12">
      <div className="max-w-6xl mx-auto px-2 md:px-4 flex flex-col md:flex-row items-start justify-between gap-4">
        <div className="w-full bg-white rounded-lg p-4 shadow-md md:w-1/4">
        ...
        <div className="w-full md:w-3/4 bg-white rounded-lg p-4 shadow-md">
          <Image
            src="/avatar.png"
            height={100}
            width={100}
          ...
          <div className="p-4 shadow-md border border-gray-200 rounded-lg mt-4">
            <h3 className="text-lg capitalize text-gray-700">
              Personal Details
            </h3>
